...
5.   用于魔改系统行为，LSPosed，[LSPosed/LSPosed](https://github.com/LSPosed/LSPosed.git)
     ...
     12.   PlayIntegrityFix，[KOWX712/PlayIntegrityFix](https://github.com/KOWX712/PlayIntegrityFix.git)，谷歌 play 完整性校验绕过；另外推荐谷歌完整性检查工具 [spic](simple play integrity checker)
     13.   safetynet-fix，[kdrag0n/safetynet-fix](https://github.com/kdrag0n/safetynet-fix.git)，谷歌 play 完整性校验绕过（另一方案）
